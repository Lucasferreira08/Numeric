...
import sympy as sp
from Metodos.FalsaPosicao.fp import fp
from Metodos.Secantes.secantes import secantes


class secantesFormulario(tk.Frame):
    ...
    def submit(self):
        ...
        self.controller.switch_frame(secantes(self.controller, inicio, fim, tol, func_lambda, max_iter))